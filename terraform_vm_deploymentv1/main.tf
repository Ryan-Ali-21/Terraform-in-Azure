...
# Connect the security group to the network interface
resource "azurerm_network_interface_security_group_association" "vm_two_nsg_connection" {
  network_interface_id      = azurerm_network_interface.vm_two_nic.id
  network_security_group_id = azurerm_network_security_group.myterraformnsg.id
}
